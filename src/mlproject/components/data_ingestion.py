...
class DataIngenstion:
    ...
    def initiate_data_ingenstion(self):
        try:
            ...
            df.to_csv(self.ingenstion_config.train_data_path,index=False,header=True)
            df.to_csv(self.ingenstion_config.test_data_path,index=False,header=True)

            logging.info("Data Ingenstion is Completed")
